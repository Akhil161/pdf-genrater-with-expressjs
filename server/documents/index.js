...
return `
    ...
    //      
       ...
       <div class='name-container'>
           ...
           <hr style="border: 1px dashed rgba(0, 0, 0, 0.2)"></hr>
       ...
       <div class="pdf-Plan-container">
          ...
          <hr style="border: 1px dashed rgba(0, 0, 0, 0.1);margin:0"></hr>
       ...
       <div class='pdf-Plan-container'>
       <div><span class='pdf-plan-detail'>${planDuration} subscription fee </span><span style="float:right">₹ ${planRate}</span></div>
       <div><span class='pdf-plan-detail'>Security deposit (refundable)</span><span style="float:right">₹ ${securityDeposite}</span></div>
       <div><span class='pdf-plan-detail'>Installation fee (one time)</span><span style="float:right">₹ ${installionCharges}</span></div>
       <div  style=${`display:${dis};`}><span class='pdf-plan-detail'>Discount</span><span style="float:right;color: rgba(33, 154, 81, 0.9)">- ₹ ${discount}</span></div>
       <div><span class='pdf-plan-detail'>Taxes & charges</span><span style="float:right">₹ ${tax}</span></div>
       <hr style="border: 1px dashed rgba(0, 0, 0, 0.1);marginTop:5%;marginBottom:5%"></hr>
       <div class='total-rate'><span class='pdf-plan-detail-total'>Total Bill</span><span style="float:right">₹ ${total}</span></div>
       </div>
